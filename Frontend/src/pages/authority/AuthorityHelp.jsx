...
const AuthorityHelp = () => {
    ...
    return (
        <div className="space-y-8 pb-12 max-w-4xl mx-auto">
            ...
            >
                <h3 className="text-lg font-bold text-emerald-950 dark:text-white mb-6 border-b border-emerald-900/10 dark:border-white/10 pb-4">
                    Contact Support
                </h3>
                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-center py-2 border-b border-emerald-900/5 dark:border-white/5">
                        ...
                        <span className="text-emerald-950 dark:text-white font-bold">support@rise.ops</span>
                    </div>
                    <div className="flex justify-between items-center py-2">
                        ...
                        <span className="text-emerald-950 dark:text-white font-bold">+91 98765 43210</span>
                    </div>
                </div>
            </motion.div>
