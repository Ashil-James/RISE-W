...
import {
    Construction, Clock, CheckCircle, AlertTriangle, ArrowRight, AlertCircle,
    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            try {
                ...
                const analyticsRes = await fetch("/api/v1/authority/road/analytics", { headers: authHeader });
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <div className="h-72 w-full mt-auto">
                        {analyticsLoading ? (
                            <div className="w-full h-full flex justify-center items-center"><RefreshCw className="animate-spin text-orange-400" /></div>
                        ) : (
