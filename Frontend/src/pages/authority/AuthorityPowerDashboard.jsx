...
import {
    Zap, Clock, CheckCircle, AlertTriangle, ArrowRight, AlertCircle,
...
const StatCard = ({ title, value, icon: Icon, delay, loading }) => (
    ...
    >
        <div className="flex items-center justify-between mb-4">
            <div className="p-3 bg-amber-50 dark:bg-amber-500/10 text-amber-500 dark:text-amber-400 rounded-2xl">
    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            try {
                ...
                const analyticsRes = await fetch("/api/v1/authority/power/analytics", { headers: authHeader });
        ...
        <div className="space-y-6 pb-12">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-slate-500 dark:text-white/40 text-xs font-bold uppercase tracking-widest flex items-center gap-1.5">
                                <Layers size={14} /> Power Authority
                            </span>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <div className="h-72 w-full mt-auto">
                        {analyticsLoading ? (
                            <div className="w-full h-full flex justify-center items-center"><RefreshCw className="animate-spin text-amber-400" /></div>
                        ) : (
                        ...
                        {analyticsLoading ? (
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={weeklyData} margin={{ top: 10, right: 0, left: -20, bottom: 0 }}>
                                    <defs>
                                        <linearGradient id="colorCountPower" x1="0" y1="0" x2="0" y2="1">
                                    ...
                                    <Area type="monotone" dataKey="count" stroke="#f59e0b" strokeWidth={3} fillOpacity={1} fill="url(#colorCountPower)" />
                                </AreaChart>
                            </ResponsiveContainer>
                        )}
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                >
                    <div className="flex items-center gap-3 mb-6">
                        <div className="p-2 rounded-xl bg-amber-50 dark:bg-amber-500/10">
                            <PieChartIcon size={18} className="text-amber-600 dark:text-amber-400" />
                        </div>
                        <div>
