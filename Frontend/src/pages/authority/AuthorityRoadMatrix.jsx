                    ...
                    <div className="flex items-center gap-3 w-full lg:w-auto">
                        <div className="relative flex-1 lg:w-64">
                            ...
                            <input
                                ...
                                className="w-full bg-black/40 border border-emerald-900/10 dark:border-white/10 text-emerald-950 dark:text-white text-sm rounded-xl pl-9 pr-4 py-2.5 focus:outline-none focus:border-orange-500/50 transition-colors placeholder:text-gray-600 shadow-inner"
                            />
                        </div>
                                ...
                                {loading ? (
                                    ...
                                    filteredData.map((row) => (
                                        <tr key={row.ref} className="hover:bg-emerald-900/5 hover:dark:hover:bg-white/5 transition-colors group cursor-default">
                                            ...
                                            <td className="px-5 py-4 text-sm font-black text-emerald-950 dark:text-white">{row.urg}</td>
                                            ...
                                            <td className="px-5 py-4 text-right">
                                                <button
                                                    ...
                                                    className="inline-flex items-center gap-1.5 px-4 py-2 bg-orange-500/10 hover:bg-orange-500 text-orange-400 hover:text-emerald-950 hover:dark:hover:text-white border border-orange-500/30 rounded-lg text-xs font-bold transition-all shadow-lg hover:shadow-orange-500/25 group/btn"
                                                >
                                                    {row.protocol}
