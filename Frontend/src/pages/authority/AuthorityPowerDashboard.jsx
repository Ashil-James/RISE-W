...
const CRITICAL_MOCK = [
    { id: "POW-1021", category: "Grid Failure", subtype: "Main Transformer Burst", loc: "Sector G", urg: 92, status: "New", days: 1 },
    { id: "POW-1025", category: "Safety", subtype: "Live Wire Damage", loc: "Sector A", urg: 98, status: "New", days: 2 },
    { id: "POW-1030", category: "Infrastructure", subtype: "Voltage Fluctuation", loc: "Sector C", urg: 55, status: "In Progress", days: 3 },
];
                        ...
                        <tbody className="divide-y divide-white/5">
                            {CRITICAL_MOCK.map((row) => (
                                <tr key={row.id} className="hover:bg-white/5 transition-colors group">
                                    <td className="px-6 py-4 font-mono text-sm text-amber-400 font-bold">{row.id}</td>
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <button
                                            onClick={() => navigate(`/authority/power/case/${row.id.replace('#', '')}`)}
